...
\icmlauthor{Student 2 Name}{userID1@swarthmore.edu}
...
your final report.  This is also an example for how to use the templates to write your
  paper in \LaTeX.  {\bf This document is not authoritative, you should use the course
   \href{https://www.cs.swarthmore.edu/courses/CS66/S21/finalProject/}{Project Writeup} for
   the exact requirements of your final project}.
...
Submissions must be compiled as a PDF (you can use the provided Makefile to do this).
...
of the field of machine learning, but does not have familiarity with your specific project.
It is important to motivate and explain your approach in this context.
We highly recommend having a classmate proofread your paper at
